...
class SymfonyFileLocatorTest extends DoctrineTestCase
{
    ...
    public function testFindMappingFile()
    {
        ...
        $this->assertEquals(dirname(__FILE__) . "/_files/stdClass.yml", $locator->findMappingFile("Foo\\stdClass"));
    }
    ...
    public function testFindMappingFileNotFound()
    {
        ...
        $this->setExpectedException(
            ...
            "No mapping file found named '".dirname(__FILE__)."/_files/stdClass2.yml' for class 'Foo\stdClass2'."
        );
