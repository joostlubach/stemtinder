...
class DotenvTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        Dotenv::load(dirname(dirname(__FILE__)) . '/fixtures');
    ...
    {
        Dotenv::load(dirname(dirname(__FILE__)) . '/fixtures', 'commented.env');
    ...
    {
        Dotenv::load(dirname(dirname(__FILE__)) . '/fixtures', 'quoted.env');
    ...
    {
        Dotenv::load(dirname(dirname(__FILE__)) . '/fixtures', 'exported.env');
    ...
    {
        Dotenv::load(dirname(dirname(__FILE__)) . '/fixtures', 'nested.env');
    ...
    {
        Dotenv::load(dirname(dirname(__FILE__)) . '/fixtures', null);
    ...
    {
        Dotenv::load(dirname(dirname(__FILE__)) . '/fixtures', 'specialchars.env');
